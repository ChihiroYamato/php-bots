...
{
    /**
     * @var \GuzzleHttp\Client $client instance of Guzzle client class
     */
    protected GuzzleHttp\Client $client;
    /**
     * @var \PHPHtmlParser\Dom $DomDocument instance of Dom parser class
     */
    protected PHPHtmlParser\Dom $DomDocument;
    /**
     * @var string[] $buffer local buffer for web content
     */
     ...
     * @param string[] $selectorsParam list of selectors params
     * @return void
     */
